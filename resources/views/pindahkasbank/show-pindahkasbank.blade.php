                            ...
                            <div class="card-header">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tanggal" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $pindahkasbank->tanggal }}" readonly>
                                    </div>
                                    <label class="control-label">Kas Bank</label>
                                    <div>
                                        <select class="custom-select form-control-border" name="kas_bank" aria-label="Default select example" disabled>
                                    ...
                                    <div>
                                        <select class="custom-select form-control-border" name="pindah_ke" aria-label="Default select example" disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="keterangan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $pindahkasbank->keterangan }}" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1" class="form-label">Nominal</label>
                                        <input type="number" name="nominal" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $pindahkasbank->nominal }}" readonly>
                                    </div>
                                    <div class="form-group d-flex justify-content-end">
                                        <a href="/data-pindahkasbank" class="btn btn-primary">Kembali</a>
                                    </div>
                                </form>
                            </div>
                        </div>
