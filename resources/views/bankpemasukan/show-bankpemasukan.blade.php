                                ...
                                <div class="card-body">
                                    <label class="control-label">Unit</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tanggal_mutasi_bank" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $bankpemasukan->tanggal_mutasi_bank }}" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="form-label">No. Ref</label>
                                            <input type="text" name="no_ref" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $bankpemasukan->no_ref }}" readonly>
                                        </div>
                                        <label class="control-label">Letak Kas Bank</label>
                                        <div>
                                            <select class="custom-select form-control-border" name="letak_kas_bank" aria-label="Default select example" disabled>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="atas_nama_pengirim" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $bankpemasukan->atas_nama_pengirim }}" readonly>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="nominal" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $bankpemasukan->nominal }}" readonly>
                                        </div>
                                        <div class="form-group d-flex justify-content-end">
                                            <a href="/data-bankpemasukan" class="btn btn-primary">Kembali</a>
                                    </div>
                                </form>
                            </div>
                        </div>
