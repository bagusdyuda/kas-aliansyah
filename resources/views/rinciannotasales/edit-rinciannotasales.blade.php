                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header">
                                <h3>Edit Data</h3>
                                <div class="card-body">
                                    <form action="{{ url('update-rinciannotasales',$rinciannotasales->id) }}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="form-label">ID Unit</label>
                                            <input type="number" name="id_unit" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $rinciannotasales->id_unit }}">
                                        </div>
                                        <label class="control-label">Nama Unit</label>
                                        <div>
                                            <select class="custom-select form-control-border" name="nama_unit" aria-label="Default select example">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tanggal_setor" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $rinciannotasales->tanggal_setor }}">
                                        </div>
                                        <label class="control-label">Nama Customer</label>
                                        <div>
                                            <select class="custom-select form-control-border" name="nama_customer" aria-label="Default select example">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="nominal" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $rinciannotasales->nominal }}">
                                        </div>
