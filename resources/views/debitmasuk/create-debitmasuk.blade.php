                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header">
                                <h3>Tambah Data</h3>
                                <div class="card-body">
                                    <form action="{{ route('simpan-debitmasuk') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="letak_kas_bank" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                        </div>
                                        <div class="form-group">
